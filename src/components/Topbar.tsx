  ...
  return (
    <header className="sticky top-0 z-30 border-b border-[color:var(--border)] bg-[color:var(--surface)]/88 px-3 py-3 backdrop-blur-md lg:px-4">
      <div className="flex flex-col gap-3 lg:flex-row lg:items-center">
        ...
        >
          <span className="flex h-9 w-9 items-center justify-center rounded-xl bg-[color:var(--surface)] text-[color:var(--text-soft)] shadow-[inset_0_1px_0_rgba(255,255,255,0.7)]">
          ...
          <span className="ml-auto rounded-lg border border-[color:var(--border)] bg-[color:var(--surface)] px-2 py-1 font-mono text-[10px] text-[color:var(--text-soft)]">
            Ctrl K
          </span>
        </button>
        ...
        <div className="flex flex-wrap items-center gap-2 lg:justify-end">
          <button
            className="inline-flex items-center gap-2 rounded-xl border border-[color:var(--border)] bg-[color:var(--surface)] px-3 py-2 text-sm font-medium text-[color:var(--text)] transition hover:bg-[color:var(--bg)]"
            type="button"
          ...
          <button
            className={`inline-flex items-center gap-3 rounded-2xl border px-3 py-2 text-left transition ${
              defaultWorkflow
                ? 'border-[color:var(--ready)]/30 bg-[color:var(--ready)]/10 text-[color:var(--text)] shadow-[0_10px_24px_rgba(99,153,34,0.10)]'
                : 'border-[color:var(--border-strong)] bg-[color:var(--surface)] text-[color:var(--text)]'
            }`}
            type="button"
